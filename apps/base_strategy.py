...
class StrategyConfig:
    ...
    # Optional custom market selector (overrides coin-based 15m discovery)
...
class BaseStrategy(ABC):
    ...
    def __init__(self, bot: TradingBot, config: StrategyConfig):
        ...
        # Core components — use an explicit selector if provided via config.selector
        _selector = getattr(config, "selector", None)
